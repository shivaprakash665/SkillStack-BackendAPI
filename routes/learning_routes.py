...
def delete_learning_goal(goal_id):
    user_id = request.args.get('user_id')
    return LearningGoalController.delete_learning_goal(user_id, goal_id)
...
@learning_bp.route('/sessions/<int:session_id>', methods=['DELETE'])
def delete_session(session_id):
    user_id = request.args.get('user_id')
    return SessionController.delete_session(user_id, session_id)
